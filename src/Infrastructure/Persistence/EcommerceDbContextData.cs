...
{
    public static async Task LoadDataAsync(EcommerceDbContext context, UserManager<Usuario> userManager,
    ...
    ILoggerFactory loggerFactory)
    {
        try
        {
            ...
            if (!userManager.Users.Any())
            {
                ...
                await userManager.CreateAsync(usuarioAdmin, "PasswordVaxiDrez123$");
                ...
                await userManager.CreateAsync(usuario, "PasswordDamonSalvatore123$");
            ...
            if (!context.Categories!.Any())
            {
                ...
                //Aqui Descerealice la Data aun conjunto de objetos tipos category
